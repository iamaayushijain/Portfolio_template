...
function Tooltip(_ref) {
  ...
  return React__default.createElement(reactPopper.Manager, null, React__default.createElement(reactPopper.Reference, null, function (_ref2) {
  ...
  }, canUseDom.default && isOpen.isOpen && React__default.createElement(reactPopper.Popper, {
    placement: position,
    modifiers: {
      offset: {
    ...
    return (// This function is documented within `react-popper`:
      ...
      }, text, React__default.createElement("div", null, cta && cta.type === 'link' && React__default.createElement("a", {
        href: cta.href,
      ...
      }, cta.text), cta && cta.type === 'button' && React__default.createElement(index.TextButton, {
        onClick: cta.onClick
      }, cta.text)))), React__default.createElement("div", {
