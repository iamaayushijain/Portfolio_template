...
function StarRating(_ref) {
  ...
  return React__default.createElement("div", {
    className: classNames(styles.root, (_classNames = {}, _rollupPluginBabelHelpers.defineProperty(_classNames, styles.small, size === 'small'), _rollupPluginBabelHelpers.defineProperty(_classNames, styles.large, size === 'large'), _rollupPluginBabelHelpers.defineProperty(_classNames, styles.medium, size === 'medium'), _classNames)),
    "data-star": ratingValue,
    "aria-label": ariaLabel,
    onMouseLeave: onMouseLeave,
    role: isInteractive ? undefined : 'img'
  }, isInteractive && React__default.createElement("div", {
